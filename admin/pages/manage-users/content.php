    ...
    <div class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Manage & Edit Users</h3>
        </div>
          ...
          <table class="table table-striped projects">
              ...
              <tbody>
                ...
                <?php
                    ...
                    $all_data = $admin->usersData($pagination->offset, $pagination->limit);
                    if ($all_data):
                ...
                ?>
                  ...
                  <tr id="id_data_<?php echo Secure::escape($userlist->id); ?>">
                      ...
                      <td class="project-actions text-right">
                          <div class="d-inline" id="load_delete_admin_<?php echo Secure::escape($userlist->id); ?>">
                            <button type="button" class="btn btn-danger btn-sm" onClick="deleteData(<?php echo Secure::escape($userlist->id); ?>);">
                                Delete
                            </button>
                          </div>
                      </td>
